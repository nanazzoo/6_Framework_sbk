...
//Controller 어노테이선: 컴파일러에게 현재 클래스가 Controller임을 알려줌
...
//			기존: path = request.getHeader("referer");
...
//			-> 메인페이지 주소에 message값 노출
//			-> RedirectAttribute로 변환
...
//		한글이 깨지는 이유
//		 -> Post 요청시 인코딩 방식 지정 필요 -> 인코딩 필터 처리(web.xml)
		
//		Spring은 
//			1) 같은 name의 input 태그의 값을 값,값,값,값... 자동으로 하나의 문자열로 만듦
...
//		매개변수 Exception e: 발생한 예외 전달받는 매개변수
