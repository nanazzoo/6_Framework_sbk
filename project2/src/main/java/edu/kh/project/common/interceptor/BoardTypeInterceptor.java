...
// Dispatcher Servlet <-> 컨트롤러 사이에 요청/응답을 가로채서
// 특정 코드를 수행하는 기능(Spring)
// ** Dispatcher Servlet 이후에 동작하므로 각종 Spring 어노테이션을
//    인식하고 bean을 DI 할 수 있다 **
...
//	  (forward를 통해 응답 화면이 생성 완료된 후 수행)
