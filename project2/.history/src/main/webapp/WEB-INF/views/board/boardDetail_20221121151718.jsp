...
<body>
                ...
                <c:if test="${not empty thumbnail}">
                    ...
                    <div class="img-box">
                        <div class="boardImg thumbnail">
                            ...
                            <a href="${thumbnail.imagePath}${thumbnail.imageReName}" download >다운로드</a>         
                        </div>
                    </div>
                </c:if>
                    ...
                    <div class="img-box">
                        ...
                        <c:forEach var="i" begin="${start}" end="${fn:length(board.imageList) - 1}">
                            <div class="boardImg">
                                ...
                                <a href="${board.imageList[i].imagePath}${board.imageList[i].imageReName}" download>다운로드</a>                
                            </div>                       
                        </c:forEach>
    ...
    // 참고) JSP 해석 순서: EL/JSTL > HTML > JS
        // *** Js에 EL/JETL 사용 시 양쪽에 "" 또는 ''를 붙이는 것을 권장 ***
